...
export const KATALOG = [
  ...
  },
  {
    ...
    description: 'Sagt in Zahlen, wie die Figur in einem Frame steht: Weltpositionen der Koerperteile in '
      ...
      + 'hat, mit Betrag), sohlen_m je Fuss — dort steht neben der tiefsten Sohle GETRENNT die '
      + 'Hoehe von ferse und spitze sowie stand: flach, zehenstand, fersenstand oder frei. Nur so '
      + 'siehst du, WIE der Fuss aufliegt: eine Figur auf Zehenspitzen meldet als tiefsten Punkt '
      + 'ebenfalls 0, waehrend ihre Ferse handbreit in der Luft haengt. Dazu, ob der Frame eine gesetzte '
